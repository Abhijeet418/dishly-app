  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6 sm:mb-8">Create New Recipe</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
              ...
              {formData.ingredients.map((ingredient, index) => (
                <div key={index} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center justify-center gap-2 sm:gap-1"
                  >
              ...
              {formData.instructions.map((instruction, index) => (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-3 py-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center justify-center sm:justify-start gap-2"
                    >
                      <Trash2 className="w-4 h-4" />
                      <span className="sm:hidden text-sm">Remove Step</span>
                    </button>
                  </div>
                  <textarea
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <button
              type="submit"
              disabled={isLoading}
              className="btn-primary flex items-center justify-center space-x-2 flex-1 disabled:opacity-50 py-3"
            >
